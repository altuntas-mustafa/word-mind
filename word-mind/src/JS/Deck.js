...
import { fetchLanguagesAndDecksFromFirebase } from "./firebaseUtils";
            ...
            <div
              ...
              className={`border border-gray-200 p-4 rounded shadow-md mr-7 ${
                selectedLanguage === language.id
                  ? ""
                  : "text-black duration-150 bg-gradient-to-r from-blue-600 via-blue-300 to-green-300 border-b border-gray-400 rounded-lg focus:shadow-outline"
              }`}
            >
              <h2
