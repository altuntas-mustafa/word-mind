...
const Flashcards = () => {
  ...
  {!isFlipped ? (
    <div className="mb-3 font-normal text-gray-900 dark:text-gray-700 flex flex-col items-center justify-center h-[300px] w-[400px] overflow-hidden">
      <div className="mb-3 font-normal text-gray-900 dark:text-gray-700 items-center text-center overflow-hidden">
    ...
    <div className="mb-3 font-normal text-gray-700 dark:text-gray-400 flex flex-col items-center justify-center h-[300px] w-[400px] overflow-hidden">
      <p className="mb-1 font-normal text-gray-700 dark:text-gray-400 font-serif whitespace-pre-wrap">
